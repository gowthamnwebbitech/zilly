                ...
                <div class="container">
                    <div class="footer-top-wrap">
                        <div class="footer-logo">
                            <a href="home-electric-accessories.html">
                    ...
                    <div class="row-footer">
                                ...
                                <div class="footer-contact">
                                    <ul class="footer-info">
                                        ...
                                        <li class="item">
                                            ...
                                            <a href="tel:18888383022" class="">(64) 8342 1245</a>
                                        </li>
                                        <li class="item">
                                            <span class="box-icon">
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                            ...
                                            <a href="mailto:support@example.com" class="">support@example.com</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div id="sib-form-container" class="sib-form-container">
                                            ...
                                            <div id="sib-container"
                                                ...
                                                <form id="sib-form" method="POST" class="form-newsletter"
                                                    action="https://3c02c1a1.sibforms.com/serve/MUIFAJqAmJ1r-9-6oGaX4uoBvwP0hlwYezUpuGWNLMl1Fd26Yuqeza4itBfViudv3o5IiTs34IhyGGpR3u821lD5dVskLiPw6XN9KtRy5CvmDj75857141ERQ9FKXtHPty7V8KYAUgKgTOv906xqY0rEG_reNR88R8xpH0aoS6WQ-5lXA1_ZioeDYB9dOJu11g7EJLdgHAieoeK5"
                        ...
                        <div class="footer-inner-wrap s3">
                            <div class="footer-col-block inner-col">
                                <div class="footer-heading footer-heading-mobile text-xl fw-medium ">About Us
                                </div>
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        ...
                                        <li>
                                            <a class="" href="store-location.html">Our Store</a>
                                        </li>
                                        <li>
                            ...
                            <div class="footer-col-block inner-col">
                                ...
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        <li>
                                            <a class="" href="privacy-policy.html">Privacy Policies</a>
                                        </li>
                                        <li>
                                            <a class="" href="term-and-condition.html">Terms & Conditions</a>
                                        </li>
                                        <li>
                                            <a class="" href="return-and-refund.html">Returns & Refunds</a>
                                        </li>
                                        <li>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="footer-bottom-wrap">
                        <p class="text-dark ">Copyright © 2025 by <span class="fw-medium">Vineta.</span> All
                            Rights
                            Reserved.</p>
                        <ul class="tf-payment">
