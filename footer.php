        ...
        <div class="container">
            <div class="footer-top-wrap">
                <div class="footer-logo">
                    <a href="index.php">
                        <img src="images/logo/zillylogo.webp" class="logo" alt="Zilly Bags Logo">
                    </a>
                </div>
                    ...
                    <div class="footer-col-block inner-col">
                        ...
                        <div class="tf-collapse-content">
                            <ul class="footer-menu-list">
                                <li><a href="about.php">About Zilly Bags</a></li>
                                <li><a href="contact-us.php">Contact Us</a></li>
                                <li><a href="product.php">Shop Bags</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-wrap">
                ...
                <ul class="tf-payment">
                    <li class="item"><img src="images/payment/Visa.png" alt="Visa"></li>
                    <li class="item"><img src="images/payment/Mastercard.png" alt="Mastercard"></li>
                    <li class="item"><img src="images/payment/GooglePay.png" alt="Google Pay"></li>
                    <li class="item"><img src="images/payment/ApplePay.png" alt="Apple Pay"></li>
                    <li class="item"><img src="images/payment/UnionPay.png" alt="UnionPay"></li>
                </ul>
            </div>
        </div>
    </div>
