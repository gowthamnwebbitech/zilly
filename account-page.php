                        ...
                        <ul class="my-account-nav">
                            ...
                            <li>
                                <a href="account-orders.php"
                                    class="text-sm link fw-medium my-account-nav-item">My Orders</a>
                            </li>
                            <li>
                                <a href="wish-list.php"
                                    class="text-sm link fw-medium my-account-nav-item">My Wishlist</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="index.php"
                                    class="text-sm link fw-medium my-account-nav-item">Log Out</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="my-acount-content account-dashboard">
                        <div class="box-account-title">
                            ...
                            <p class="notice text-sm">
                                ...
                                <a href="account-orders.php"
                                    class="text-primary text-decoration-underline">your recent orders</a>,
                                revisit
                                <a href="wish-list.php"
                                    class="text-primary text-decoration-underline">your wishlist</a>,
                                or explore
                                <a href="shop-default.php"
                                    class="text-primary text-decoration-underline">our latest collections</a>.
                            </p>
                        </div>
                            ...
                            <div class="banner-account">
                                <div class="image">
                                    <img src="images/banner/account-1.jpg"
                                        data-src="images/banner/account-1.jpg"
                                        alt="Zilly Free Shipping"
                                        class="lazyload">
                                </div>
...
<!-- Mirrored from themesflat.co/html/vineta/account-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Dec 2025 07:23:44 GMT -->
