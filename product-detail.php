                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom"
                                        ...
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="black" data-size="small">
                                                <div class="item">
                                                    <img class="lazyload" src="images/products/bags/product1.jpg"
                                                        data-src="images/products/bags/product1.jpg" alt="Women's Bag">
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="black"
                                                data-size="medium">
                                                <div class="item">
                                                    <img class="lazyload" src="images/products/bags/product2.jpg"
                                                        data-src="images/products/bags/product2.jpg" alt="Women's Bag">
                                                </div>
                                            </div>

                                            <div class="swiper-slide stagger-item" data-color="brown" data-size="large">
                                                <div class="item">
                                                    <img class="lazyload" src="images/products/bags/product3.jpg"
                                                        data-src="images/products/bags/product3.jpg" alt="Women's Bag">
                                                </div>
                                            </div>

                                            <div class="swiper-slide stagger-item" data-color="tan"
                                                data-size="extra large">
                                                <div class="item">
                                                    <img class="lazyload" src="images/products/bags/product4.jpg"
                                                        data-src="images/products/bags/product4.jpg" alt="Women's Bag">
                                                </div>
                                            </div>

                                            <div class="swiper-slide stagger-item" data-color="black" data-size="small">
                                                <div class="item">
                                                    <img class="lazyload" src="images/products/bags/product5.jpg"
                                                        data-src="images/products/bags/product5.jpg" alt="Women's Bag">
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="brown"
                                                data-size="medium">
                                                <div class="item">
                                                    <img class="lazyload" src="images/products/bags/product6.jpg"
                                                        data-src="images/products/bags/product6.jpg" alt="Women's Bag">
                                                </div>
                                            </div>

                                            <div class="swiper-slide stagger-item" data-color="tan" data-size="large">
                                                <div class="item">
                                                    <img class="lazyload" src="images/products/bags/product7.jpg"
                                                        data-src="images/products/bags/product7.jpg" alt="Women's Bag">
                                                </div>
                                            </div>
                                                ...
                                                <div class="swiper-slide">
                                                    <a href="images/products/bags/product1.jpg" class="item">
                                                        <img class="tf-image-zoom lazyload"
                                                            ...
                                                            data-zoom="images/products/bags/product1.jpg"
                                                            alt="Women's Bag">
                                                    </a>
                                                </div>

                                                <div class="swiper-slide">
                                                    <a href="images/products/bags/product2.jpg" class="item">
                                                        <img class="tf-image-zoom lazyload"
                                                            src="images/products/bags/product2.jpg"
                                                            data-zoom="images/products/bags/product2.jpg"
                                                            alt="Women's Bag">
                                                    </a>
                                                </div>

                                                <div class="swiper-slide">
                                                    <a href="images/products/bags/product3.jpg" class="item">
                                                        <img class="tf-image-zoom lazyload"
                                                            src="images/products/bags/product3.jpg"
                                                            data-zoom="images/products/bags/product3.jpg"
                                                            alt="Women's Bag">
                                                    </a>
                                                </div>

                                                <div class="swiper-slide">
                                                    <a href="images/products/bags/product4.jpg" class="item">
                                                        <img class="tf-image-zoom lazyload"
                                                            src="images/products/bags/product4.jpg"
                                                            data-zoom="images/products/bags/product4.jpg"
                                                            alt="Women's Bag">
                                                    </a>
                                                </div>

                                                <div class="swiper-slide">
                                                    <a href="images/products/bags/product5.jpg" class="item">
                                                        <img class="tf-image-zoom lazyload"
                                                            src="images/products/bags/product5.jpg"
                                                            data-zoom="images/products/bags/product5.jpg"
                                                            alt="Women's Bag">
                                                    </a>
                                                </div>

                                                <div class="swiper-slide">
                                                    <a href="images/products/bags/product6.jpg" class="item">
                                                        <img class="tf-image-zoom lazyload"
                                                            src="images/products/bags/product6.jpg"
                                                            data-zoom="images/products/bags/product6.jpg"
                                                            alt="Women's Bag">
                                                    </a>
                                                </div>

                                                <div class="swiper-slide">
                                                    <a href="images/products/bags/product7.jpg" class="item">
                                                        <img class="tf-image-zoom lazyload"
                                                            src="images/products/bags/product7.jpg"
                                                            data-zoom="images/products/bags/product7.jpg"
                                                            alt="Women's Bag">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="tf-bundle-products">
                                            ...
                                            <div class="tf-bundle-product-item item-has-checkbox check">
                                                ...
                                                <a href="product-detail.php" class="bundle-image">
                                                    <img src="images/products/bags/product1.jpg"
                                            ...
                                            <div class="tf-bundle-product-item item-has-checkbox">
                                                ...
                                                <a href="product-detail.php" class="bundle-image">
                                                    <img src="images/products/bags/product4.jpg"
                                                        alt="Women's Mini Pouch">
                                                </a>
                                            ...
                                            <div class="tf-bundle-product-item item-has-checkbox">
                                                ...
                                                <a href="product-detail.php" class="bundle-image">
                                                    <img src="images/products/bags/product6.jpg"
                                ...
                                <div class="card-product style-2 card-product-size">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.php" class="product-img">
                                            ...
                                            <img class="img-hover lazyload" data-src="images/products/bags/product2.jpg"
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot active">
                                                ...
                                                <img class=" lazyload" data-src="images/products/bags/product2.jpg"
                                                    src="images/products/bags/product2.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch hover-tooltip line tooltip-bot">
                                                <span class="tooltip color-filter">White</span>
                                                <span class="swatch-value bg-white"></span>
                                                <img class=" lazyload" data-src="images/products/bags/product3.jpg"
                                            ...
                                            <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                                ...
                                                <img class=" lazyload" data-src="images/products/bags/product4.jpg"
                                    ...
                                    <div class="card-product-wrapper">
                                        ...
                                        <ul class="list-product-btn">
                                            <li><a href="#shoppingCart" data-bs-toggle="offcanvas"
                                                    class="box-icon"><span class="icon icon-cart2"></span></a></li>
...
<!-- Mirrored from themesflat.co/html/vineta/product-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Dec 2025 07:23:06 GMT -->
