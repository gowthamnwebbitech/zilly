            ...
            <div class="col-xl-8 d-none d-xl-block">
                <nav class="box-navigation text-center">
                    <ul class="box-nav-menu">
                        ...
                        <li class="menu-item">
                            <a href="about.php" class="item-link">About</a>
                        </li>
                        <li class="menu-item">
                            <a href="product.php" class="item-link">Product</a>
                        </li>
                        <li class="menu-item">
                            <a href="contact-us.php" class="item-link">Contact Us</a>
                        </li>
                        <li class="menu-item">
                            <a href="faq.php" class="item-link">Faq</a>
                        </li>
                    </ul>
                </nav>
            </div>
