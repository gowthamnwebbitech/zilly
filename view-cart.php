                                ...
                                <table class="table-page-cart">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="tf-cart-item file-delete">
                                            <td class="tf-cart-item_product">
                                                <a href="product-detail.html" class="img-box">
                                                    <img src="images/products/bags/product1.jpg" alt="Zilly Urban Backpack">
                                                </a>
                                                <div class="cart-info">
                                                    <a href="product-detail.html"
                                                        class="name text-md link fw-medium">Zilly Urban Backpack</a>
                                        ...
                                        <tr class="tf-cart-item file-delete">
                                            <td class="tf-cart-item_product">
                                                <a href="product-detail.html" class="img-box">
                                                    <img src="images/products/bags/product3.jpg" alt="Zilly Office Laptop Bag">
                                                </a>
                                                <div class="cart-info">
                                                    <a href="product-detail.html"
                                                        class="name text-md link fw-medium">Zilly Office Laptop Bag</a>
                                        ...
                                        <tr class="tf-cart-item file-delete">
                                            <td class="tf-cart-item_product">
                                                <a href="product-detail.html" class="img-box">
                                                    <img src="images/products/bags/product6.jpg" alt="Zilly Leather Handbag">
                                                </a>
                                                <div class="cart-info">
                                                    <a href="product-detail.html"
                                                        class="name text-md link fw-medium">Zilly Leather Handbag</a>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="card-product style-2">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="img-product" src="images/products/bags/product1.jpg" alt="Zilly Laptop Bag">
                                    <img class="img-hover" src="images/products/bags/product1.jpg" alt="Zilly Laptop Bag">
                                </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card-product style-2">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="img-product" src="images/products/bags/product2.jpg" alt="Zilly Office Bag">
                                    <img class="img-hover" src="images/products/bags/product2.jpg" alt="Zilly Office Bag">
                                </a>
                            </div>
                            <div class="card-product-info">
                                <a href="product-detail.html" class="name-product link fw-medium text-md">
                    ...
                    <div class="swiper-slide">
                        <div class="card-product style-2">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="img-product" src="images/products/bags/product3.jpg" alt="Zilly Backpack">
                                    <img class="img-hover" src="images/products/bags/product3.jpg" alt="Zilly Backpack">
                                </a>
                            </div>
                            <div class="card-product-info">
                                <a href="product-detail.html" class="name-product link fw-medium text-md">
                    ...
                    <div class="swiper-slide">
                        <div class="card-product style-2">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="img-product" src="images/products/bags/product4.jpg" alt="Zilly Travel Bag">
                                    <img class="img-hover" src="images/products/bags/product4.jpg" alt="Zilly Travel Bag">
                                </a>
                            </div>
                            <div class="card-product-info">
                                <a href="product-detail.html" class="name-product link fw-medium text-md">
...
<!-- Mirrored from themesflat.co/html/vineta/view-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Dec 2025 07:23:48 GMT -->
