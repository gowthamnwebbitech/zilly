            ...
            <div class="container">
                <div class="box-title text-center">
                    ...
                    <div class="breadcrumb-list">
                        ...
                        <a class="breadcrumb-item" href="product.php">Collections</a>
                        <div class="breadcrumb-item dot"><span></span></div>
                                    ...
                                    <div class="widget-facet">
                                        ...
                                        <div id="collections" class="collapse show">
                                            <ul class="collapse-body list-categories current-scrollbar">
                                                <li class="cate-item">
                                                    <a class="text-sm link" href="product.php">
                                                        <span>Handbags</span>
                        ...
                        <div class="wrapper-control-shop">
                            ...
                            <div class="tf-list-layout wrapper-shop" id="listLayout" style="display: none;">
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <div class="list-product-btn">
                                            <a href="#shoppingCart" data-bs-toggle="offcanvas"
                                                class="tf-btn btn-main-product add-to-cart animate-btn">
                                                Add To Cart
                                            </a>
                                ...
                                <ul class="wg-pagination">
                                    ...
                                    <li><a href="#" class="pagination-item"><i class="icon-arr-right2"></i></a></li>
                                </ul>
